...
In order to include the pilot session, perform this adjustment before running
the spatial deconvolution.
"""
...
# Path of npz file with depth profiles of pilot session (Meta-conditoin, ROI,
# condition left open.)

...
lstPths = ['/combined_uncorrected/crf_power_modelfit_bars.svg',
           '/combined_corrected/crf_power_modelfit_bars.svg']
lstPths = [(strPthBase + x) for x in lstPths]

# Output path:
strOt = '/home/john/Dropbox/ParCon_Manuscript/Figures_Source/Figure_S02_residuals.svg'  #noqa

# Create parent SVG figure:
objFigPrnt = sg.SVGFigure(width='400.0 pix', height='350.0 pix')

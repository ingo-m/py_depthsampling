...
strVtkDpth01 = '/home/john/PhD/PacMan_Depth_Data/{}/cbs_distcor/lh/pe_{}.vtk'  # noqa
...
strCsvRoi = '/home/john/PhD/PacMan_Depth_Data/{}/cbs_distcor/lh/{}.csv'  #noqa
...
strVtkSlct03 = '/home/john/PhD/PacMan_Depth_Data/{}/cbs_distcor/lh/R2_multi.vtk'  #noqa
...
strVtkSlct04 = '/home/john/PhD/PacMan_Depth_Data/{}/cbs_distcor/lh/combined_mean.vtk'  #noqa
# Threshold for vertex selection:
varThrSlct04 = 7000.0
...
lstNumVrtx = [500] * len(lstSubIds)

# Base name of second set of vtk files with depth-sampled data, e.g. z-values
# (with subject ID left open):
strVtkDpth02 = '/home/john/PhD/PacMan_Depth_Data/{}/cbs_distcor/lh/zstats_Dynamic.vtk'  #noqa
...
strPltOtSuf = '_R2multi_0p08_combinedmean_7000_z_1000.png'
...
strDpthMeans = '/home/john/PhD/PacMan_Depth_Data/Higher_Level_Analysis/{}.npy'.format(strRoi)  #noqa
...
for idxSub in range(0, varNumSubs):
    ...
    # criterion II:
    lstVtkDpth02 = [strVtkDpth02.format(lstSubIds[idxSub])] * varNumCon

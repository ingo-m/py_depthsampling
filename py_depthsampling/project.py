...
lstCon = ['feat_level_2_bright_square_sst_pe',
          ...
          'feat_level_2_bright_square_trn_pe',
          'feat_level_2_bright_square_trn_zstat',
          'feat_level_2_dark_square_sst_pe',
          'feat_level_2_dark_square_sst_zstat',
          'feat_level_2_dark_square_trn_pe',
          'feat_level_2_dark_square_trn_zstat',
          'feat_level_2_kanizsa_sst_pe',
          'feat_level_2_kanizsa_sst_zstat',
          'feat_level_2_kanizsa_trn_pe',
          'feat_level_2_kanizsa_trn_zstat',

...
strPltOtPre = '/home/john/PhD/Tex/tex_pe_review/plots_{}_nrstngb/'.format(strRoi)
...
strDpthMeans = '/media/sf_D_DRIVE/MRI_Data_PhD/04_ParCon/Depth_Data_Review/Higher_Level_Analysis/{}_review_nrstngb.npy'.format(strRoi)  #noqa

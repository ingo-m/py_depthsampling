...
lstCsvRoi = ['/media/sf_D_DRIVE/MRI_Data_PhD/04_ParCon/20161207/cbs_distcor/lh/v1.csv',  #noqa
...
lstVtkSlct02 = ['1', '2']  #noqa
# Threshold for vertex selection for 2nd selection criterion (e.g. minimum pRF
# overlap):
varThrSlct02 = 0.3

# (3)
# Use third selection criterion (e.g. venogram or T2* weighted mean image)?
lgcSlct03 = True
...
lstVtkSlct03 = ['/media/sf_D_DRIVE/MRI_Data_PhD/04_ParCon/20161207/cbs_distcor/lh/20161207_mp2rage_seg_v32_lh__surf_05_inf_R2.vtk',  #noqa
...
strPltOtSuf = '_depthplot_test.png'

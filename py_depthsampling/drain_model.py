...
for idxMdl in range(len(lstMdl)):  #noqa
    ...
    drain_model(lstMdl[idxMdl], lstRoi[idxRoi], lstHmsph[idxHmsph],
                strPthPrf.format(lstRoi[idxRoi], lstHmsph[idxHmsph]),
                strPthPrfOt.format(lstRoi[idxRoi], lstHmsph[idxHmsph],

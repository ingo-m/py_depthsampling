...
if strCrct == 'uncorrected':
    dicPthDpth = {'V1': '/media/sf_D_DRIVE/MRI_Data_PhD/04_ParCon/Depth_Data_Review/Higher_Level_Analysis/v1.npy'}  #noqa
if strCrct == 'corrected':
    dicPthDpth = {'V1': '/media/sf_D_DRIVE/MRI_Data_PhD/04_ParCon/Depth_Data_Review/Higher_Level_Analysis/v1_corrected_model_1.npy'}  #noqa
